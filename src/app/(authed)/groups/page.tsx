...
export default async function GroupsPage({ searchParams }: GroupsPageProps) {
  ...
  const categoriesMatchTypes = competitions.reduce((acc, competition) => {
    if (!acc[competition.category]) {
      acc[competition.category] = [];
    }

    acc[competition.category]?.push(competition.matchType);
    ...
    <div className="px-4 py-8 sm:px-6 lg:px-8">
      <div className="space-y-4 mb-8">
        <div className="flex justify-between items-center">
          ...
          <CreateGroupDialog categoriesMatchTypes={categoriesMatchTypes} />
        </div>
        ...
        {error && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              ...
              {error === "invalid-group" &&
                "Invalid group link. Please check the URL and try again."}
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Join groups to participate in activities with other players.
                </p>
              </CardContent>
            </Card>
          ) : (
          ...
          {groups.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Create your first group to start organizing activities with
                  other players.
                </p>
                <CreateGroupDialog
