                  ...
                  <div key={game.id} className="rounded-lg border p-3 sm:p-4 transition-colors hover:bg-muted/50">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex items-center gap-2 justify-center">
                        <span className="font-medium text-sm sm:text-base">{game.winnerTeam.map((playerId) => playerMap.get(playerId)).join(", ")}</span>
                      ...
                      <div className="flex items-center gap-2 justify-center">
                        <span className="font-medium text-sm sm:text-base">{game.playerTeam.map((playerId) => playerMap.get(playerId)).join(", ")}</span>
                        {game.playerApproved && !game.winnerApproved && (
                          <Badge variant="outline" className="text-xs bg-primary">
                            Approved
                          </Badge>
