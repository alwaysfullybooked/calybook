...
export default function TennisRankings() {
	...
	const samplePlayers = [
		{ id: 1, name: "Jeremy Scott", rank: 1, points: 1580, trend: "stable", lastMatch: "2 days ago" },
	...
	const upcomingMatches = [
		{ id: 1, challenger: "Jim Halpert", challenged: "Jeremy Scott", date: "May 21, 2025", time: "18:30" },
	...
	const recentResults = [
		...
		{ id: 4, winner: "Jeremy Scott", loser: "Stanley Hudson", score: "6-1, 6-0", points: "+20" },
	];
