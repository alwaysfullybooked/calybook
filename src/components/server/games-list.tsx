    ...
    <Card>
      ...
      <CardContent className="px-6">
        <div className="space-y-3 sm:space-y-4">
          {games.map((game) => (
            <Card key={game.id} className="hover:shadow-md transition-shadow max-w-lg mx-auto">
                  ...
                  <div className="text-center col-span-2">
                    <span className="font-bold text-sm sm:text-base capitalize flex flex-col items-center justify-center gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={game?.winnerRankingVariation && game.winnerRankingVariation >= 0 ? "text-green-500" : "text-red-500"}>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={game?.playerRankingVariation && game.playerRankingVariation >= 0 ? "text-green-500" : "text-red-500"}>
