						...
						{currentStep === "payment" && paymentImage && (
							<div className="space-y-2">
								<div className="rounded-lg">
									<Image src={paymentImage} alt="Payment QR Code" className="mx-auto" width={200} height={200} />
								</div>
						...
						{currentStep === "success" && paymentType === "manual_prepaid" && (
							<div className="rounded-lg bg-orange-50 p-4 text-orange-800 text-center">
								...
								<div className="mt-4 flex flex-col items-center justify-center gap-2">
									<Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/LINE_logo.svg/320px-LINE_logo.svg.png" alt="Line" className="mx-auto h-16 w-16" width={64} height={64} />
