...
function CreateGroupFormContent({ onSuccess, categoriesMatchTypes }: { onSuccess?: () => void; categoriesMatchTypes: Record<string, string[]> }) {
						...
						render={({ field }) => (
							<FormItem>
								...
								<Select onValueChange={field.onChange} defaultValue={field.value}>
									...
									<SelectContent>
										{categoriesMatchTypes[form.watch("category")]?.map((matchType) => (
								...
								<FormDescription>Select the match type for this group.</FormDescription>
								<FormMessage />
							</FormItem>
						)}
					/>
...
export function CreateGroupForm({ onSuccess, variant = "standalone", categoriesMatchTypes }: CreateGroupFormProps) {
	if (variant === "dialog") {
		return <CreateGroupFormContent onSuccess={onSuccess} categoriesMatchTypes={categoriesMatchTypes} />;
	}
	...
	return (
		<Card className="w-full max-w-md mx-auto">
			...
			<CardContent>
				<CreateGroupFormContent onSuccess={onSuccess} categoriesMatchTypes={categoriesMatchTypes} />
			</CardContent>
		</Card>
	);
}

export function CreateGroupDialog({ onSuccess, trigger, categoriesMatchTypes }: CreateGroupDialogProps) {
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-md">
				...
				<CreateGroupForm variant="dialog" onSuccess={handleSuccess} categoriesMatchTypes={categoriesMatchTypes} />
			</DialogContent>
		</Dialog>
	);
}
